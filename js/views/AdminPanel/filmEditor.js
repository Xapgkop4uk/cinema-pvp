  ...
  var container = $('<div>').append($('<form class="admin-form">')
      .append($('<div class="group">')
        ...
        .append($('<label class="label-text">')
          .html('Название')))
      .append($('<div class="group">')
        .append($('<div class="file-input">')
          .append($('<label id="click" style="top:40px;">')
            .append($('<i class="material-icons upload" style="position:absolute;font-size: 30px;color: #1a1f23;border: 1px solid black;z-index: 2;  box-shadow: 0 1px 4px rgba(0, 0, 0,0.4);">')
              .html('file_upload'))
            .append($('<input id="file_input_file" class="none" type="file" accept=".jpg, .jpeg, .png" name="image">')))
          .append($('<div style="position: absolute;top: -8px;">')
            .append($('<input id="picture" name="movie" required="" readonly="" type="text">')
              .append($('<span class="bar bar-adm">'))
              .append($('<label id="label-picture"class="label-text">')
                .html('Постер'))))))
      .append($('<div class="group">')
